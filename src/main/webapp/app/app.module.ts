...
@NgModule({
  imports: [
    ...
    SpingularchatsqlSharedModule.forRoot(),
    SpingularchatsqlCoreModule,
    SpingularchatsqlHomeModule,
    SpingularchatsqlAccountModule,
