...
import com.spingular.chat.SpingularchatsqlApp;
 ...
 */
@SpringBootTest(classes = SpingularchatsqlApp.class)
public class ChatMessageResourceIT {
    ...
    public void createChatMessage() throws Exception {
        ...
        assertThat(testChatMessage.isIsOffensive()).isEqualTo(DEFAULT_IS_OFFENSIVE);
    }
    ...
    @Test
    @Transactional
    public void getAllChatMessagesByIsOffensiveIsEqualToSomething() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where isOffensive equals to DEFAULT_IS_OFFENSIVE
        defaultChatMessageShouldBeFound("isOffensive.equals=" + DEFAULT_IS_OFFENSIVE);

        // Get all the chatMessageList where isOffensive equals to UPDATED_IS_OFFENSIVE
        defaultChatMessageShouldNotBeFound("isOffensive.equals=" + UPDATED_IS_OFFENSIVE);
    }

    @Test
    @Transactional
    public void getAllChatMessagesByIsOffensiveIsInShouldWork() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where isOffensive in DEFAULT_IS_OFFENSIVE or UPDATED_IS_OFFENSIVE
        defaultChatMessageShouldBeFound("isOffensive.in=" + DEFAULT_IS_OFFENSIVE + "," + UPDATED_IS_OFFENSIVE);

        // Get all the chatMessageList where isOffensive equals to UPDATED_IS_OFFENSIVE
        defaultChatMessageShouldNotBeFound("isOffensive.in=" + UPDATED_IS_OFFENSIVE);
    }

    @Test
    @Transactional
    public void getAllChatMessagesByIsOffensiveIsNullOrNotNull() throws Exception {
        // Initialize the database
        chatMessageRepository.saveAndFlush(chatMessage);

        // Get all the chatMessageList where isOffensive is not null
        defaultChatMessageShouldBeFound("isOffensive.specified=true");

        // Get all the chatMessageList where isOffensive is null
        defaultChatMessageShouldNotBeFound("isOffensive.specified=false");
    }
    ...
    public void updateChatMessage() throws Exception {
        ...
        assertThat(testChatMessage.isIsOffensive()).isEqualTo(UPDATED_IS_OFFENSIVE);
    }
