...
public class ChatRoomAllowedUserResource {
    ...
    public ResponseEntity<List<ChatRoomAllowedUserDTO>> getAllChatRoomAllowedUsers(ChatRoomAllowedUserCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
