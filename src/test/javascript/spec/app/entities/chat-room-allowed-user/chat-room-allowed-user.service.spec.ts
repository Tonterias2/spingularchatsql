...
describe('Service Tests', () => {
  describe('ChatRoomAllowedUser Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ChatRoomAllowedUser', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            creationDate: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a ChatRoomAllowedUser', async () => {
        const returnedFromService = Object.assign(
          {
            creationDate: currentDate.format(DATE_TIME_FORMAT),
            bannedUser: true,
      ...
      it('should return a list of ChatRoomAllowedUser', async () => {
        const returnedFromService = Object.assign(
          {
            creationDate: currentDate.format(DATE_TIME_FORMAT),
            bannedUser: true,
      ...
      it('should delete a ChatRoomAllowedUser', async () => {
